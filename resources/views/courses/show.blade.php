                ...
                <div class="card-body">
                    ...
                    @else
                        ...
                        @if ($course->price->value)
                            <p class="mt-4 text-gray-500 text-xl"><span class="font-bold">Precio:</span> {{$course->price->value}} US$</p>

                            <a class="btn btn-danger btn-block mt-3" href="{{route('courses.paymet', $course)}}">Comprar el curso</a>

                        @else

                            <p class="mt-4 text-gray-500 text-xl"><span class="font-bold">Precio:</span> GRATIS</p>
